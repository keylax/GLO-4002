...
@Provider
public class StockDateNotFoundExceptionMapper implements ExceptionMapper<StockDateNotFoundException> {
    ...
    public Response toResponse(StockDateNotFoundException _exception) {
